...
We are interested in studying how several factors impact the lifespan of these CMRs. The factors we study here include: 
  ...
  - Clinic: The clinic in which the CMR was placed 
...
TODO: Add an explanation of the summary stats (esp for numerics). Change numeric summary to be median (range) instead of median (IQR)
